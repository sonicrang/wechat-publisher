...
const STYLES: Record<string, string> = {
  ...
  table: 'color:#333;width:100%;border-collapse:separate;border-spacing:0;border-radius:8px;margin:1em 8px;overflow:hidden;border:1px solid #dfdfdf;',
  th: `border:1px solid #dfdfdf;padding:0.5em 1em;background:${PRIMARY_COLOR};color:#fff;font-weight:bold;`,
  td: 'border:1px solid #dfdfdf;padding:0.5em 1em;',
  strong: `color:${PRIMARY_COLOR};font-weight:bold;`,
  a: 'color:#576b95;text-decoration:none;',
  img: 'width:100%;max-width:100%;height:auto;margin:0.1em 8px 0.5em;border-radius:4px;display:block;',
  figure: 'margin:1.5em 8px;width:100%;',
...
function addInlineStyles(html: string): string {
  ...
  const styleReplacements = [
    ...
    { pattern: /<figure[^>]*>/g, style: 'margin:1.5em 0;width:100%;' },
    { pattern: /<img[^>]*src="[^"]*"[^>]*>/g, style: 'width:100%;max-width:100%;height:auto;margin:0.1em 0 0.5em;border-radius:4px;display:block;' },
