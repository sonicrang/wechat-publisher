...
const STYLES: Record<string, string> = {
  ...
  table: 'color:#333;width:max-content;min-width:800px;border-collapse:separate;border-spacing:0;border-radius:8px;margin:0.5em 8px;overflow:hidden;border:1px solid #dfdfdf;',
